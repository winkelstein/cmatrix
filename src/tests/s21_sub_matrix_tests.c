...
START_TEST(s21_sub_matrix_test1) {
  ...
  expected_result.matrix[0][0] = 16;
  expected_result.matrix[0][1] = 2;
  expected_result.matrix[1][0] = -20;
...
START_TEST(s21_sub_matrix_test2) {
  ...
  expected_result.matrix[0][1] = 2;
  expected_result.matrix[0][2] = 15;
  expected_result.matrix[1][0] = -7;
  expected_result.matrix[1][1] = 5;
  expected_result.matrix[1][2] = 15;
...
Suite *s21_sub_matrix_test_suite() {
  ...
  TCase *tc_case = tcase_create("s21_sub_matrix");
